...
export default function AssistantLayout() {
  ...
  const assistantNavItems: NavItem[] = [
    ...
    { label: t('nav.crm', lang), path: '/assistant/crm', icon: 'Target' },
    { label: t('nav.crm_leads', lang), path: '/assistant/crm/leads', icon: 'UserPlus' },
    { label: t('nav.followups', lang), path: '/assistant/crm/followups', icon: 'Bell' },
