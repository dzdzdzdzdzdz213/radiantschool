  ...
  return (
    <>
      ...
      <motion.aside
        ...
        initial={false}
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex flex-col border-r border-sidebar-border bg-sidebar-bg lg:static lg:h-full',
          'lg:translate-x-0',
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 py-3 sidebar-nav-scroll">
