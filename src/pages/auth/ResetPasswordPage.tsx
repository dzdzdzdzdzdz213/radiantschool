      ...
      <div className="w-full max-w-md">
        ...
        {done ? (
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border bg-card p-8 shadow-sm">
            ...
            <button type="submit" disabled={loading} className="w-full rounded-lg bg-primary py-2.5 text-sm font-medium text-white hover:bg-primary/90 disabled:opacity-50">{loading ? 'Réinitialisation...' : 'Réinitialiser'}</button>
          </form>
        )}
      </div>
    </div>
