...
import { Sparkles, BookOpen, Calendar, Award, TrendingUp } from 'lucide-react';
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t('nav.certificates', lang)}</p>
              <p className="text-2xl font-bold">—</p>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardContent className="p-8 text-center">
          <p className="text-muted-foreground">
            Votre tableau de bord est en cours de configuration. Les fonctionnalités détaillées seront bientôt disponibles.
          </p>
        </CardContent>
      </Card>
    </motion.div>
