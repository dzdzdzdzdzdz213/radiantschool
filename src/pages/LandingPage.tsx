        ...
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-10 relative">
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-12">
            ...
            <div className="sm:col-span-2 lg:col-span-4">
              ...
              <div className="mt-6 flex gap-3">
                <a href="#" className="flex h-10 w-10 items-center justify-center rounded-xl transition-all duration-200 hover:scale-110 hover:shadow-md" style={{ backgroundColor: `color-mix(in srgb, var(--primary) 8%, transparent)` }}>
          ...
          <div className="mt-16 pt-8 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs" style={{ borderTop: '1px solid var(--border)', color: 'var(--fg-muted)' }}>
            ...
            <div className="flex gap-8">
              <a href="#" className="transition-all duration-200 hover:text-[var(--fg)] hover:underline underline-offset-4">Mentions légales</a>
              <a href="#" className="transition-all duration-200 hover:text-[var(--fg)] hover:underline underline-offset-4">CGV</a>
              <a href="#" className="transition-all duration-200 hover:text-[var(--fg)] hover:underline underline-offset-4">Confidentialité</a>
            </div>
          </div>
        </div>
      </footer>
