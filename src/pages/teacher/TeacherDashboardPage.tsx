...
import { Sparkles, BookOpen, Calendar, Users, Clock } from 'lucide-react';
      ...
      <Card>
        <CardContent className="p-8 text-center">
          <p className="text-muted-foreground">
            Votre espace enseignant est en cours de configuration. Les fonctionnalités détaillées seront bientôt disponibles.
          </p>
        </CardContent>
      </Card>
    </motion.div>
